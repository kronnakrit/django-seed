...
This library turn off ``auto_add`` and ``auto_add_now`` of DateField by default. If you want to disable this function, you can insert more parameters into ``seed.execute``
